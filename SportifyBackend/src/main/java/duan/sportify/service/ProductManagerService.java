...
public class ProductManagerService {
     ...
     * @return SalesReportDTO containing product-wise sales and total sales for the day
     */
     ...
     * @return SalesReportDTO containing product-wise sales and total sales for the month
     */
