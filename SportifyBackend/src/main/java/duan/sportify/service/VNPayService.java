...
public class VNPayService {
  ...
  public String generateRefundUrl(String inputMoney, String ipAddress, String appUserId, String token, Integer bookingId) throws Exception {
    System.out.println("Generating refund URL...");
    System.err.println( "Input Money: " + inputMoney + ", IP Address: " + ipAddress + ", App User ID: " + appUserId + ", Token: " + token);
