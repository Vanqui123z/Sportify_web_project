      ...
      <div className="sidebar-content p-3">
        <ul className="nav flex-column">
          <li className="nav-item mb-1">
            ...
            >
              <i className="fa-solid fa-gauge-high me-3 text-primary"></i>
              <span>Dashboard</span>
            </a>
          </li>
          ...
          <li className="nav-item mb-1">
            <a
              ...
              className="nav-link d-flex align-items-center py-2 px-3 rounded text-dark"
            >
              <i className="fa-solid fa-store me-3 text-success"></i>
              <span>Sản phẩm</span>
            </a>
          </li>
          ...
          <li className="nav-item mb-1">
            <a
              ...
              className="nav-link d-flex align-items-center py-2 px-3 rounded text-dark"
            >
              <i className="fa-solid fa-futbol me-3 text-warning"></i>
          ...
          <li className="nav-item mb-1">
            <a
              ...
              className="nav-link d-flex align-items-center py-2 px-3 rounded text-dark"
            >
              <i className="fa-solid fa-users-gear me-3 text-info"></i>
          ...
          <li className="nav-item mb-1">
            <a
              ...
              className="nav-link d-flex align-items-center py-2 px-3 rounded text-dark"
            >
              <i className="fa-solid fa-blog me-3 text-danger"></i>
            ...
            <div className="accordion" id="otherAccordion">
              <div className="accordion-item border-0">
                <h6 className="accordion-header">
                  ...
                  >
                    <i className="fa-solid fa-pen me-3 text-secondary"></i>
                    <span>Khác</span>
                  </button>
                </h6>
                <div
                    ...
                    <ul className="nav flex-column ms-4">
                      <li className="nav-item">
                        <a
                          ...
                          className="nav-link d-flex align-items-center py-2 px-3 rounded text-dark"
                        >
                          <i className="fa-solid fa-gift me-3 text-primary"></i>
                      ...
                      <li className="nav-item">
                        <a
                          ...
                          className="nav-link d-flex align-items-center py-2 px-3 rounded text-dark"
                        >
                          <i className="fa-solid fa-comments me-3 text-success"></i>
                          <span>Liên hệ</span>
                        </a>
                      </li>
                    </ul>
            ...
            <div className="accordion" id="bookingAccordion">
              <div className="accordion-item border-0">
                <h6 className="accordion-header">
                  ...
                  >
                    <i className="fa-solid fa-bullhorn me-3 text-warning"></i>
                    ...
                    <ul className="nav flex-column ms-4">
                      <li className="nav-item">
                        <a
                          ...
                          className="nav-link d-flex align-items-center py-2 px-3 rounded text-dark"
                        >
                          <i className="fa-solid fa-ticket me-3 text-primary"></i>
                      ...
                      <li className="nav-item">
                        <a
                          ...
                          className="nav-link d-flex align-items-center py-2 px-3 rounded text-dark"
                        >
                          <i className="fa-solid fa-receipt me-3 text-success"></i>
                          <span>Đơn hàng</span>
                        </a>
                      </li>
                    </ul>
            ...
            <div className="accordion" id="categoryAccordion">
              <div className="accordion-item border-0">
                <h6 className="accordion-header">
                  ...
                  >
                    <i className="fa-solid fa-boxes-stacked me-3 text-info"></i>
                    ...
                    <ul className="nav flex-column ms-4">
                      <li className="nav-item">
                        <a
                          ...
                          className="nav-link d-flex align-items-center py-2 px-3 rounded text-dark"
                        >
                          <i className="fa-solid fa-vest-patches me-3 text-primary"></i>
                      ...
                      <li className="nav-item">
                        <a
                          ...
                          className="nav-link d-flex align-items-center py-2 px-3 rounded text-dark"
                        >
                          <i className="fa-solid fa-spa me-3 text-success"></i>
            ...
            <div className="accordion" id="reportAccordion">
              <div className="accordion-item border-0">
                <h6 className="accordion-header">
                  ...
                  >
                    <i className="fa-solid fa-chart-column me-3 text-danger"></i>
                    ...
                    <ul className="nav flex-column ms-4">
                      <li className="nav-item">
                        <a
                          ...
                          className="nav-link d-flex align-items-center py-2 px-3 rounded text-dark"
                        >
                          <i className="fa-solid fa-chart-line me-3 text-primary"></i>
                      ...
                      <li className="nav-item">
                        <a
                          ...
                          className="nav-link d-flex align-items-center py-2 px-3 rounded text-dark"
                        >
                          <i className="fa-solid fa-chart-area me-3 text-success"></i>
