...
const OwnerBookingManagerPage: React.FC = () => {
    ...
    <div className="page-wrapper py-4">
      <div className="container-fluid bg-white rounded shadow p-4">
        ...
        <div className="row align-items-center mb-4">
          <div className="col">
            <h3 className="mb-0 fw-bold text-dark">Quản lý Phiếu Đặt Sân</h3>
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb bg-transparent p-0 mt-2">
                ...
                <li className="breadcrumb-item active text-secondary" aria-current="page">Quản lý Phiếu Đặt</li>
              </ol>
            </nav>
          </div>
        </div>
...
export default OwnerBookingManagerPage;
