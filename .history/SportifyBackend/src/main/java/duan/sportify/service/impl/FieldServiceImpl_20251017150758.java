...
public class FieldServiceImpl implements FieldService {
	...
	@Override
	public List<Field> findNearestFields(Double userLat, Double userLng, String sporttypeId, Integer limit) {
        ...
        for (Object[] result : results) {
            ...
            Field field = (Field) result[0];
            // Lưu khoảng cách để có thể hiển thị nếu cần
            field.getClass(); // Đảm bảo entity được load đầy đủ
            fields.add(field);
            count++;
        }
