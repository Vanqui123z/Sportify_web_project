...
- Đảm bảo tính riêng tư với thông báo được phân tách theo người dùng
- Hệ thống thông báo nhất quán trên tất cả các tính năng của ứng dụng

### Cập nhật và sửa lỗi
- Đã khắc phục lỗi thông báo chung cho tất cả người dùng
- Đã tích hợp với AuthContext để lấy thông tin người dùng đăng nhập
- Cải thiện cách lưu trữ trong localStorage với khóa riêng cho từng người dùng
- Đảm bảo thông báo được làm mới khi người dùng đăng nhập/đăng xuất
