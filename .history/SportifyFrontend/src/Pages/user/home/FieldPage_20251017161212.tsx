...
export default function FieldPage() {
  ...
  useEffect(() => {
    ...
    if (latitude && longitude) {
      ...
      console.log('Đang gọi API tìm sân gần nhất với tọa độ:', latitude, longitude);
      fetch(`/api/sportify/field/nearest?latitude=${latitude}&longitude=${longitude}`)
        .then(response => {
  ...
  if (error) {
    return (
      <div className="alert alert-danger m-4 text-center">
        <h4>Đã xảy ra lỗi</h4>
        <p>{error}</p>
        <button className="btn btn-primary mt-3" onClick={() => window.location.href = '/sportify/field'}>
            ...
            <div className="col-12 mb-4 pb-4 d-flex justify-content-center">
              <div className="row w-100 align-items-center">
                ...
                <div className="col-md-3 mb-3">
                  <NearestFieldFinder className="w-100" />
                </div>
