              ...
              notifications.map((notification) => (
                ...
                >
                  <div className="notification-type-icon">
                    {notification.type === 'success' && <i className="fa fa-check-circle" style={{ color: '#28a745' }}></i>}
                    {notification.type === 'error' && <i className="fa fa-exclamation-circle" style={{ color: '#dc3545' }}></i>}
                    {notification.type === 'warning' && <i className="fa fa-exclamation-triangle" style={{ color: '#ffc107' }}></i>}
                    {notification.type === 'info' && <i className="fa fa-info-circle" style={{ color: '#17a2b8' }}></i>}
                  </div>
